...
<div class="overview-boxes">
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="number">123456789102</div>
            <div class="indicator">
            </div>
          </div>
    ...
    <div class="title">Editar ticket</div>
    <div class="content">
      <form method="POST" action="">
        ...
        <div class="input-box">
          Criticidade
        <select name="select_criticidade" style="width: 230px; height:45px; border-radius: 5px;border-color: #0000ff;" required>
            <option value="">Selecione</option>
            <option value="1"> Alterar a criticidade</option>
        </select></div><br>
        ...
        <div class="input-box">
          Categoria
        <select name="select_cat1" style="width: 230px; height:45px; border-radius: 5px;border-color: #0000ff;" required>
          <option value="">Selecione</option>
          <option value="1"> Alterar a categoria</option>
        </select></div>
       <div class="input-box">
        ...
        <input type="submit" value="Editar Ticket" name="Uptkt">
        </div>
      </form>

      <a href="consultar_ticket.php" style="text-decoration: none"><img src="img/voltar.png" alt="voltar" > Consultar ticket</a>
    </div>
  </div>
</div>
</div>
        ...
        <div class="top-sales box"style="width: 50%";>
          ...
          <ul class="top-sales-details">
            ...
            <li>
            <a>
              <span class="product">OTRS: 123456789102</span>
            </a>
          ...
          <li>
            <a>
              <span class="product">DATA ABERTURA: 17-11-2021 12:00:00</span>
            </a>
          </li>
          <li>
            <a>
              <span class="product">DATA FECHAMENTO: Sem data de fechamento</span>
            </a>
          </li>
          <li>
            <a>
